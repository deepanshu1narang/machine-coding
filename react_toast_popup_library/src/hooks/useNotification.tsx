...
import { NotificationProps, PositionType, UseNotificationReturn } from "../components/types";

const useNotification = (position: PositionType = "bottom-right"): UseNotificationReturn => {
  ...
  const triggerNotification = useCallback((notificationProps: NotificationProps) => {
    ...
    setNotifications((prevNotifications) => [...prevNotifications, { id: toastId, ...notificationProps }]);
